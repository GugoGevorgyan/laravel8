...
@section('content')
    <div class=" center">
        <div class="container-md container-fluid pt-4 z-index-n1">
            ...
            <div class="center w-100 container p-0 pt-4 pb-5 position-relative">
                <div class="all_computers container">
                    ...
                    <div class="d-block d-lg-none"><h3
                            class="justify-content-sm-center d-flex d-lg-block popular_text  pt-4 pb-4">Recommended for
                            you</h3></div>
                </div>
...
{{--                        col-xl-3 p-3 col-md-4 col-sm-6  disp2-none--}}
                                ">
                                <div class="hot_sales_imgs_container just_around ">
                                    <div class="d-flex flex-row position-relative h-15">
                                        @if($computer -> sale)
