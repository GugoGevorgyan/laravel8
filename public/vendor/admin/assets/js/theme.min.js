"use strict";
var Demo = function () {
    var n = document.querySelector("#demoForm"), s = document.querySelector("#topnav"),
        i = document.querySelector("#topbar"), c = document.querySelector("#sidebar"),
        d = document.querySelector("#sidebarUser"), u = document.querySelectorAll('[class^="container"]'),
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var a, e, t, o, r, l;
        "light" == (a = colorScheme) ? (p.disabled = !1, h.disabled = !0) : "dark" == a && (p.disabled = !0, h.disabled = !1), function (a) {
            if (s && i && c && d) if ("topnav" == a) {
                t(i), t(c);
                for (var e = 0; e < u.length; e++) u[e].classList.remove("container-fluid"), u[e].classList.add("container")
            } else if ("combo" == a) for (t(s), t(d), e = 0; e < u.length; e++) u[e].classList.remove("container"), u[e].classList.add("container-fluid"); else if ("sidenav" == a) for (t(s), t(i), e = 0; e < u.length; e++) u[e].classList.remove("container"), u[e].classList.add("container-fluid");
    ...
    var a, e = $('[data-toggle="chart"]'), t = {base: "Cerebri Sans"}, o = {
                ...
                tooltips: {
                    enabled: !1, mode: "index", intersect: !1, custom: function (r) {
                        ...
                        if (a.length || (a = $('<div id="chart-tooltip" class="popover bs-popover-top" role="tooltip"></div>'), $("body").append(a)), 0 !== r.opacity) {
                            ...
                            var t = $(this._chart.canvas), o = (t.outerWidth(), t.outerHeight(), t.offset().top),
                                s = t.offset().left, i = a.outerWidth(), c = a.outerHeight(), d = o + r.caretY - c - 16,
                                u = s + r.caretX - i / 2;
    ...
    var e = $(".dropup, .dropright, .dropdown, .dropleft"), t = $(".dropdown-menu"),
    ...
    var a = $('[data-toggle="dropzone"]'), l = $(".dz-preview");
    ...
    a.length && a.each(function () {
        var a, e;
        a = $(this), e = {mode: void 0 !== a.data("flatpickr-mode") ? a.data("flatpickr-mode") : "single"}, a.flatpickr(e)
    })
}(), Highlight = void $(".highlight").each(function (a, e) {
    var t;
    t = e, hljs.highlightBlock(t)
}), Lists = function () {
    var a = $('[data-toggle="lists"]'), e = $("[data-sort]");
    a.length && a.each(function () {
        var a, e;
    ...
    var e = $(".navbar-nav, .navbar-nav .nav"), t = $(".navbar-nav .collapse");
    t.on({
